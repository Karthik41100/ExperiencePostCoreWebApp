...
namespace ExperiencePostCoreWebApp.Controllers
{
    public class ExperiencePortalController : Controller
    {
        ...
        // GET: EmployeesPortalController/Details/5
        ...
        // GET: EmployeesPortalController/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: EmployeesPortalController/Create
        [HttpPost]
        [ValidateAntiForgeryToken]

        public ActionResult Create([Bind("EmpID,FirstName,LastName,Password,CellNumber,Email")] Employee Employee)
        {
        ...
        [HttpGet]
        // GET: EmployeesPortalController/Delete/5
        ...
        // POST: EmployeesPortalController/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
